...
pub const STATE_BURN_ALGORITHM: &str = "xparq-canonical-archival-and-net-coin-state-growth-burn-v2";
...
mod tests {
    ...
    fn burn_output_is_not_counted_as_created_ledger_state() {
        let outputs = [
            SpendOutput::new(xparq_crypto::Address::ZERO, Zeno::from_zeno(1)),
