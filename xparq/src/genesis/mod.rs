...
pub fn chain_spec_hash() -> Result<Hash, GenesisError> {
    let identity = ChainSpecIdentity {
        ...
        wasm_abi_version: xparq_extension::WASM_ABI_VERSION,
        wasm_host_call_base_fuel: xparq_extension::WASM_HOST_CALL_BASE_FUEL,
        wasm_host_fuel_per_byte: xparq_extension::WASM_HOST_FUEL_PER_BYTE,
        wasm_fuel_per_block_weight: xparq_extension::WASM_FUEL_PER_BLOCK_WEIGHT,
    };
