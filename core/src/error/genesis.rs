...
impl fmt::Display for GenesisError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            GenesisError::InvalidArtifact => f.write_str("invalid XPARQ artifact"),
            GenesisError::InvalidArtifactKind => f.write_str("invalid XPARQ artifact kind"),
            GenesisError::InvalidArtifactVersion => f.write_str("invalid XPARQ artifact version"),
            GenesisError::InvalidNetwork => f.write_str("invalid XPARQ artifact network"),
            GenesisError::InvalidPayloadHash => f.write_str("invalid XPARQ artifact payload hash"),
            GenesisError::InvalidStateCommitment => {
                f.write_str("invalid XPARQ artifact state commitment")
            }
            GenesisError::TrustAnchorMismatch => {
                f.write_str("XPARQ artifact does not match the validated trust anchor")
            }
