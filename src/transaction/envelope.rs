...
impl SignedProtocolTransaction {
    ...
    /// Amount explicitly offered to the producer of the block that includes
    /// this transaction. This is a normal transfer output, not a separate
    /// consensus fee field.
