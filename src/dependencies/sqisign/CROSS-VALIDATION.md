# SQIsign C/Rust cross-validation

## Scope

This test compares `paqus-sqisign` against the official SQIsign C reference
implementation. The C implementation is test-only and is not linked into the
Paqus library or consensus binary.
...
src/dependencies/sqisign/tools/c-validate/run-cross-validation.sh
```
