...
>
> This crate exists so Paqus devnet and testnet builds can resolve their
> SQIsign dependency. SQIsign is still a post-quantum signature candidate, this
> implementation has not received a Paqus production security audit, and its
> API and wire formats may change without compatibility guarantees.
>
> Do not use this crate for Paqus mainnet, production custody, or other
> security-critical deployments. Paqus mainnet uses ML-DSA44.
