...
impl HashDomain {
    fn tag(self) -> &'static [u8] {
        match self {
            ...
            HashDomain::PaymentAddressChecksum => b"XPARQ_PAYMENT_ADDRESS_CHECKSUM",
            HashDomain::VaultIntent => b"XPARQ_VAULT_INTENT_V1",
            HashDomain::VaultLock => b"XPARQ_VAULT_LOCK_V1",
            HashDomain::VaultOutput => b"XPARQ_VAULT_OUTPUT_V1",
            HashDomain::VaultEnvelopeKey => b"XPARQ_VAULT_ENVELOPE_KEY_V1",
            HashDomain::VaultEnvelopeStream => b"XPARQ_VAULT_ENVELOPE_STREAM_V1",
            HashDomain::VaultEnvelopeTag => b"XPARQ_VAULT_ENVELOPE_TAG_V1",
