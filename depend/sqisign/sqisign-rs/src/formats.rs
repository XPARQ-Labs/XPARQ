...
///
/// ```no_run
/// use sqisign_rs::{PublicKey, Signature, ExpandedSignature, Verifier};
///
/// # fn example(pk: &PublicKey, sig: &Signature) -> Result<(), sqisign_rs::Error> {
...
///
/// ```no_run
/// use sqisign_rs::{PublicKey, Signature, CompressedSignature, Verifier};
///
/// # fn example(pk: &PublicKey, sig: &Signature) -> Result<(), sqisign_rs::Error> {
