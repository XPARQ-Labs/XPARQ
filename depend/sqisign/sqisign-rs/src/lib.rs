...
//!
//! This crate is published only to support XPARQ devnet and testnet dependency
//! resolution. SQIsign is not standardized, this implementation is not
//! production-audited by XPARQ, and neither its API nor its wire format is
//! stable. It must not be used by XPARQ mainnet or for production custody.
//!
