    ...
    I: Iterator<Item = Fe32>,
{
    ...
    #[inline]
    pub fn new(witness_version: Option<Fe32>, iter: I) -> Self {
        Self {
            witness_version,
            iter,
        }
    ...
    I: Iterator<Item = Fe32>,
{
    ...
    fn next(&mut self) -> Option<Fe32> {
        self.witness_version.take().or_else(|| self.iter.next())
    }
    ...
    Ck: Checksum,
{
    ...
    #[inline]
    pub fn new(char_iter: CharIter<'hrp, I, Ck>) -> Self {
        Self { char_iter }
    }
}
    ...
    Ck: Checksum,
{
    ...
    fn next(&mut self) -> Option<u8> {
        self.char_iter.next().map(|c| c as u8)
    }

    #[inline]
    fn size_hint(&self) -> (usize, Option<usize>) {
        self.char_iter.size_hint()
    }
}
