    ...
    (impl for $op:ident) => {
        ...
        impl core::ops::Add<$op> for $op {
            ...
            fn add(self, other: $op) -> $op {
                $crate::primitives::Bech32Field::_add(&self, &other)
            }
        }
        ...
        impl core::ops::Sub<$op> for $op {
            ...
            fn sub(self, other: $op) -> $op {
                $crate::primitives::Bech32Field::_sub(&self, &other)
            }
        }
        ...
        impl core::ops::Mul<$op> for $op {
            ...
            fn mul(self, other: $op) -> $op {
                $crate::primitives::Bech32Field::_mul(&self, &other)
            }
        }
        ...
        impl core::ops::Div<$op> for $op {
            ...
            fn div(self, other: $op) -> $op {
                $crate::primitives::Bech32Field::_div(&self, &other)
            }
        }
        ...
        impl core::ops::Neg for $op {
            ...
            #[inline]
            fn neg(self) -> Self {
                $crate::primitives::Bech32Field::_neg(self)
            }
        }
