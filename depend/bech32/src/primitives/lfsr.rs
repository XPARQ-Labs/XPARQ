...
impl<F: Field> LfsrIter<F> {
    ...
    pub fn coefficients(&self) -> &[F] {
        &self.coeffs.as_inner()[1..]
    }

    /// Accessor for the coefficients used to compute the next element.
    pub(super) fn coefficient_polynomial(&self) -> &Polynomial<F> {
        &self.coeffs
    }
    ...
    pub fn berlekamp_massey(initial_contents: &[F]) -> LfsrIter<F> {
        assert_ne!(
            ...
            0,
            "cannot create a LFSR with no initial contents"
        );
...
mod tests {
    ...
    fn berlekamp_massey_fibonacci() {
        ...
        let parities: Vec<_> = LfsrIter::berlekamp_massey(&[Fe32::P, Fe32::P, Fe32::Q])
            .take(10)
            .collect();
        assert_eq!(
            parities,
    ...
    fn berlekamp_massey() {
        ...
        LfsrIter::berlekamp_massey(&[Fe32::Q, Fe32::P])
            .take(10)
            .count();
        ...
        LfsrIter::berlekamp_massey(&[Fe32::Q, Fe32::Y, Fe32::H])
            .take(10)
            .count();

        // Hits the the "2L <= N" path with x != L, without overflowing subtraction
        // as in the above vector.
        let sequence: Vec<_> = LfsrIter::berlekamp_massey(&[Fe32::Y, Fe32::H, Fe32::Q, Fe32::Q])
            .take(10)
            .collect();
        ...
        LfsrIter::berlekamp_massey(&[Fe32::P, Fe32::P, Fe32::Y, Fe32::Q, Fe32::Q])
            .take(10)
            .count();
