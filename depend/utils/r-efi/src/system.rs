...
pub type RuntimeGetTime =
    unsafe extern "efiapi" fn(*mut Time, *mut TimeCapabilities) -> crate::base::Status;

pub type RuntimeSetTime = unsafe extern "efiapi" fn(*mut Time) -> crate::base::Status;
...
pub type RuntimeSetWakeupTime =
    unsafe extern "efiapi" fn(crate::base::Boolean, *mut Time) -> crate::base::Status;

pub type RuntimeSetVirtualAddressMap =
    unsafe extern "efiapi" fn(usize, usize, u32, *mut MemoryDescriptor) -> crate::base::Status;

pub type RuntimeConvertPointer =
    unsafe extern "efiapi" fn(usize, *mut *mut core::ffi::c_void) -> crate::base::Status;
...
pub type RuntimeGetNextHighMonoCount = unsafe extern "efiapi" fn(*mut u32) -> crate::base::Status;

pub type RuntimeResetSystem =
    unsafe extern "efiapi" fn(ResetType, crate::base::Status, usize, *mut core::ffi::c_void);
...
pub type RuntimeQueryVariableInfo =
    unsafe extern "efiapi" fn(u32, *mut u64, *mut u64, *mut u64) -> crate::base::Status;
...
pub type BootRaiseTpl = unsafe extern "efiapi" fn(crate::base::Tpl) -> crate::base::Tpl;

pub type BootRestoreTpl = unsafe extern "efiapi" fn(crate::base::Tpl);
...
pub type BootFreePages =
    unsafe extern "efiapi" fn(crate::base::PhysicalAddress, usize) -> crate::base::Status;
...
pub type BootFreePool = unsafe extern "efiapi" fn(*mut core::ffi::c_void) -> crate::base::Status;
...
pub type BootSetTimer =
    unsafe extern "efiapi" fn(crate::base::Event, TimerDelay, u64) -> crate::base::Status;

pub type BootWaitForEvent =
    unsafe extern "efiapi" fn(usize, *mut crate::base::Event, *mut usize) -> crate::base::Status;

pub type BootSignalEvent = unsafe extern "efiapi" fn(crate::base::Event) -> crate::base::Status;

pub type BootCloseEvent = unsafe extern "efiapi" fn(crate::base::Event) -> crate::base::Status;

pub type BootCheckEvent = unsafe extern "efiapi" fn(crate::base::Event) -> crate::base::Status;
...
pub type BootUnloadImage = unsafe extern "efiapi" fn(crate::base::Handle) -> crate::base::Status;

pub type BootExitBootServices =
    unsafe extern "efiapi" fn(crate::base::Handle, usize) -> crate::base::Status;

pub type BootGetNextMonotonicCount = unsafe extern "efiapi" fn(*mut u64) -> crate::base::Status;

pub type BootStall = unsafe extern "efiapi" fn(usize) -> crate::base::Status;

pub type BootSetWatchdogTimer =
    unsafe extern "efiapi" fn(usize, u64, usize, *mut crate::base::Char16) -> crate::base::Status;
...
pub type BootCalculateCrc32 =
    unsafe extern "efiapi" fn(*mut core::ffi::c_void, usize, *mut u32) -> crate::base::Status;

pub type BootCopyMem =
    unsafe extern "efiapi" fn(*mut core::ffi::c_void, *mut core::ffi::c_void, usize);

pub type BootSetMem = unsafe extern "efiapi" fn(*mut core::ffi::c_void, usize, u8);
