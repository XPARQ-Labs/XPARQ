...
pub type ProtocolConfigure =
    unsafe extern "efiapi" fn(*mut Protocol, *mut ConfigData) -> crate::base::Status;
...
pub type ProtocolConnect =
    unsafe extern "efiapi" fn(*mut Protocol, *mut ConnectionToken) -> crate::base::Status;

pub type ProtocolAccept =
    unsafe extern "efiapi" fn(*mut Protocol, *mut ListenToken) -> crate::base::Status;

pub type ProtocolTransmit =
    unsafe extern "efiapi" fn(*mut Protocol, *mut IoToken) -> crate::base::Status;

pub type ProtocolReceive =
    unsafe extern "efiapi" fn(*mut Protocol, *mut IoToken) -> crate::base::Status;

pub type ProtocolClose =
    unsafe extern "efiapi" fn(*mut Protocol, *mut CloseToken) -> crate::base::Status;

pub type ProtocolCancel =
    unsafe extern "efiapi" fn(*mut Protocol, *mut CompletionToken) -> crate::base::Status;

pub type ProtocolPoll = unsafe extern "efiapi" fn(*mut Protocol) -> crate::base::Status;
