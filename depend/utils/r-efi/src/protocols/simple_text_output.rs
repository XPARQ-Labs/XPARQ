...
pub type ProtocolReset =
    unsafe extern "efiapi" fn(*mut Protocol, crate::base::Boolean) -> crate::base::Status;

pub type ProtocolOutputString =
    unsafe extern "efiapi" fn(*mut Protocol, *mut crate::base::Char16) -> crate::base::Status;

pub type ProtocolTestString =
    unsafe extern "efiapi" fn(*mut Protocol, *mut crate::base::Char16) -> crate::base::Status;

pub type ProtocolQueryMode =
    unsafe extern "efiapi" fn(*mut Protocol, usize, *mut usize, *mut usize) -> crate::base::Status;

pub type ProtocolSetMode = unsafe extern "efiapi" fn(*mut Protocol, usize) -> crate::base::Status;

pub type ProtocolSetAttribute =
    unsafe extern "efiapi" fn(*mut Protocol, usize) -> crate::base::Status;

pub type ProtocolClearScreen = unsafe extern "efiapi" fn(*mut Protocol) -> crate::base::Status;

pub type ProtocolSetCursorPosition =
    unsafe extern "efiapi" fn(*mut Protocol, usize, usize) -> crate::base::Status;
