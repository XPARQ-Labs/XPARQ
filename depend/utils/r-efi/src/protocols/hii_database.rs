...
pub type ProtocolRemovePackageList =
    unsafe extern "efiapi" fn(*const Protocol, crate::hii::Handle) -> crate::base::Status;
...
pub type ProtocolUnregisterPackageNotify =
    unsafe extern "efiapi" fn(*const Protocol, crate::base::Handle) -> crate::base::Status;
...
pub type ProtocolSetKeyboardLayout =
    unsafe extern "efiapi" fn(*const Protocol, *mut crate::base::Guid) -> crate::base::Status;
