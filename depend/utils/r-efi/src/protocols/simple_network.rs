...
pub type ProtocolStart = unsafe extern "efiapi" fn(*mut Protocol) -> crate::base::Status;

pub type ProtocolStop = unsafe extern "efiapi" fn(*mut Protocol) -> crate::base::Status;
...
pub type ProtocolShutdown = unsafe extern "efiapi" fn(*mut Protocol) -> crate::base::Status;
