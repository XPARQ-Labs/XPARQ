...
pub type ProtocolClose = unsafe extern "efiapi" fn(*mut Protocol) -> crate::base::Status;

pub type ProtocolDelete = unsafe extern "efiapi" fn(*mut Protocol) -> crate::base::Status;
...
pub type ProtocolGetPosition =
    unsafe extern "efiapi" fn(*mut Protocol, *mut u64) -> crate::base::Status;

pub type ProtocolSetPosition = unsafe extern "efiapi" fn(*mut Protocol, u64) -> crate::base::Status;
...
pub type ProtocolFlush = unsafe extern "efiapi" fn(*mut Protocol) -> crate::base::Status;
