...
pub type ProtocolGetInfo =
    unsafe extern "efiapi" fn(*mut Protocol, *mut usize, *mut Algorithm) -> crate::base::Status;

pub type ProtocolGetRng =
    unsafe extern "efiapi" fn(*mut Protocol, *mut Algorithm, usize, *mut u8) -> crate::base::Status;
