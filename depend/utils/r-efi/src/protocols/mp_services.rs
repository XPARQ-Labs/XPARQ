...
pub type GetNumberOfProcessors =
    unsafe extern "efiapi" fn(*mut Protocol, *mut usize, *mut usize) -> crate::base::Status;
...
pub type SwitchBsp =
    unsafe extern "efiapi" fn(*mut Protocol, usize, crate::base::Boolean) -> crate::base::Status;
...
pub type WhoAmI = unsafe extern "efiapi" fn(*mut Protocol, *mut usize) -> crate::base::Status;
