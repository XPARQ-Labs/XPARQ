...
pub type ProtocolCopyMem =
    unsafe extern "efiapi" fn(*mut Protocol, Width, u8, u64, u8, u64, usize) -> crate::base::Status;
...
pub type ProtocolUnmap =
    unsafe extern "efiapi" fn(*mut Protocol, *mut core::ffi::c_void) -> crate::base::Status;
...
pub type ProtocolFreeBuffer =
    unsafe extern "efiapi" fn(*mut Protocol, usize, *mut core::ffi::c_void) -> crate::base::Status;
