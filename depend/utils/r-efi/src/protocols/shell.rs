...
pub type GetEnv = unsafe extern "efiapi" fn(*mut crate::base::Char16) -> *mut crate::base::Char16;
...
pub type GetCurDir =
    unsafe extern "efiapi" fn(*mut crate::base::Char16) -> *mut crate::base::Char16;
...
pub type FreeFileList = unsafe extern "efiapi" fn(*mut *mut FileInfo) -> crate::base::Status;

pub type RemoveDupInFileList = unsafe extern "efiapi" fn(*mut *mut FileInfo) -> crate::base::Status;
...
pub type GetFileInfo = unsafe extern "efiapi" fn(FileHandle) -> *mut crate::protocols::file::Info;

pub type SetFileInfo =
    unsafe extern "efiapi" fn(FileHandle, *mut crate::protocols::file::Info) -> crate::base::Status;
...
pub type CloseFile = unsafe extern "efiapi" fn(FileHandle) -> crate::base::Status;
...
pub type DeleteFile = unsafe extern "efiapi" fn(FileHandle) -> crate::base::Status;

pub type DeleteFileByName =
    unsafe extern "efiapi" fn(*mut crate::base::Char16) -> crate::base::Status;

pub type GetFilePosition = unsafe extern "efiapi" fn(FileHandle, *mut u64) -> crate::base::Status;

pub type SetFilePosition = unsafe extern "efiapi" fn(FileHandle, u64) -> crate::base::Status;

pub type FlushFile = unsafe extern "efiapi" fn(FileHandle) -> crate::base::Status;

pub type FindFiles =
    unsafe extern "efiapi" fn(*mut crate::base::Char16, *mut *mut FileInfo) -> crate::base::Status;

pub type FindFilesInDir =
    unsafe extern "efiapi" fn(FileHandle, *mut *mut FileInfo) -> crate::base::Status;

pub type GetFileSize = unsafe extern "efiapi" fn(FileHandle, *mut u64) -> crate::base::Status;
...
pub type OpenRootByHandle =
    unsafe extern "efiapi" fn(crate::base::Handle, *mut FileHandle) -> crate::base::Status;
...
pub type GetEnvEx =
    unsafe extern "efiapi" fn(*mut crate::base::Char16, *mut u32) -> *mut crate::base::Char16;
